...
for j in range(0, number1-1):
    ...
    for i in range(0, number1-1):
        ...
        input_files.append(f"C:/Users/USER/Desktop/درس مرس/ارشد/ترم 2/PROJECT/S-FED DR_capW/sfedMode{a1}{a0}_{b1}{b0}.log")

output_file_path = 'C:/Users/USER/Desktop/درس مرس/ارشد/ترم 2/PROJECT/S-FED DR_capW/trans.dat'
