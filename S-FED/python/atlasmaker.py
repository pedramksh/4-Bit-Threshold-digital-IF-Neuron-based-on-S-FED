def write_to_file(filename):
    vgate_values = [round(i * 0.1, 1) for i in range(0,13)]  # Sweep vgate from 0.0 to 1.2 in steps of 0.1
    vwell_values = [round(i * 0.1, 1) for i in range(0,13)]  # Sweep vwell from 0.0 to 1.2 in steps of 0.1
